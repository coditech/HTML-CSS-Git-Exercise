...
4. Extra challenge: read [this article about the `<time>` tag](https://develdoper.mozilla.org/en-US/docs/Web/HTML/Element/time) and the `datetime=""` attribute. Use this to specify the time of each message.
...
If you are having trouble, you can review [read this guide to the semantic tags](https://devclasseloper.mozilla.org/en-US/docs/Glossary/Semantics#Semantic_elements).
